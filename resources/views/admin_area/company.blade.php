        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ $user->WEB_SITE }}" class="text-secondary mb-1">
                            {{ $user->WEB_SITE }}
                        </a>
            ...
            <form action="{{ route('admin-update-user') }}" method="post">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            <h6 class="mb-0"><b>Number of staff:</b></h6>
                        </div>
                        <div class="col-sm-9 text-secondary">
                            <input type="number" required name="EMPLOYEE_CNT" class="form-control"
                                   value="{{$user->EMPLOYEE_CNT}}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <textarea required name="DESCRIPTION">{{$user->DESCRIPTION}}</textarea>
                        </div>
                    </div>
